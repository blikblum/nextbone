...
describe('delegate', () => {
  ...
  it('should listen to events triggered in element and its children', async () => {
    const el = fixtureSync(elHTML);
    const oneEl = el.querySelector('.one');
    const oneChildEl = el.querySelector('.one-child');
    const twoEl = el.querySelector('.two');
  ...
  it('should allow to configure the context option', () => {
    const el = fixtureSync(elHTML);
  ...
  it('should support non bubbable events', async () => {
    ...
    el = fixtureSync('<div><input class="one"/><input class="two"/></div>');
  ...
  it('should support events triggered in a element with shadowDOM', async () => {
    ...
    el = fixtureSync(`<${elShadowTag}></${elShadowTag}>`);
