...
const suite = (() => {
  ...
  exportedSuite = {
      ...
      beforeEach: function () {
        class Model extends withValidation(Backbone.Model) {
          ...
          validateAge(value, attr, computedState) {
            if (![1, '1'].includes(value)) return 'Age invalid';
          }
    ...
    'Overriding built-in validator in Backbone.Validation': {
      beforeEach: function () {
        this.builtinMin = Validation.validators.min;
      ...
      afterEach: function () {
        Validation.validators.min = this.builtinMin;
      },
      ...
      beforeEach: function () {
        Object.assign(Validation.validators, {
          ...
          custom: function (value, attr, customValue, model) {
            return (
              this.required(value, attr, true, model) ||
              this.custom2(value, attr, customValue, model)
            );
          },
        });
